...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>OCODAccountControllerExtension</apexClass>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Account.todelete_del__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Contact.AccountTry_del__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <pageAccesses>
        <apexPage>AccountwithGC</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <tabVisibilities>
